    ...
    return (
        <aside
            style={{
                ...
                overflow: "hidden",
                flexShrink: 0,
                background: "linear-gradient(160deg, rgba(57,10,35,0.82) 0%, rgba(115,88,102,0.78) 100%)",
                                    ...
                                    {item.children.map(child => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                style={{
                                                    background: childActive ? "rgba(255,255,255,0.10)" : "transparent",
                                                    border: "none",
                                                    borderRadius: 8,
                                                    padding: "8px 10px",
                                                    textAlign: "left",
            ...
            <div style={{ padding: collapsed ? "16px 10px" : "16px 14px", flexShrink: 0 }}>
                {!collapsed ? (
                    ...
                    >
                        ...
                        <div style={{ fontSize: 12, color: "rgba(255,255,255,0.45)", marginBottom: 14, lineHeight: 1.4 }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: 10,
                                border: "none",
                                background: "linear-gradient(135deg, #e07b2a 0%, #c45e10 100%)",
                                color: "#fff",
                                fontSize: 13,
                                fontWeight: 700,
                                cursor: "pointer",
                                ...
                                justifyContent: "center",
                                gap: 7,
                                boxShadow: "0 4px 14px rgba(200,90,20,0.35)",
